...
ALTER TABLE iot_product ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_hardware_profile ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_protocol_profile ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_capability_model ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_capability_definition ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_credential ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_binding ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_gateway_child_device ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_connection ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_session ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_online_lease ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_command ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_command_delivery ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_command_result ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_twin ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_twin_property ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_telemetry_latest ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_telemetry_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_security_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_media_resource ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_device_media ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_firmware_artifact ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_firmware_rollout ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_firmware_rollout_target ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_firmware_deployment ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_provisioning_challenge ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_activation_record ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_protocol_message_dead_letter ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_outbox_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_inbox_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_audit_log ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_protocol_ingest_record ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE iot_admin_entity ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
