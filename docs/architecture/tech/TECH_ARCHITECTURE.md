# SDKWork AIoT Technical Architecture
...
- [TECH-production-readiness.md](TECH-production-readiness.md)
- [TECH-standards-alignment-roadmap.md](TECH-standards-alignment-roadmap.md)
- [TECH-topology-standard.md](TECH-topology-standard.md)
- [TECH-xiaozhi-protocol-parity-matrix.md](TECH-xiaozhi-protocol-parity-matrix.md)
