...
| W | Production topology + MCP deny-by-default | Complete `cloud/standalone.production` env profiles, deploy manifest profile IDs, Postgres cloud persistence keys, `SDKWORK_AIOT_XIAOZHI_MCP_POLICY_DENY_BY_DEFAULT` | Done |
