...
This directory is the local SDKWork component contract for `sdkwork-aiot-device-edge-runtime`.

- Component root: `sdkwork-aiot/crates/sdkwork-aiot-device-edge-runtime`
