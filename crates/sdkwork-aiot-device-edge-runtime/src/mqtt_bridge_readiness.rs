//! MQTT/UDP bridge signals for device edge runtime health and readiness probes.

use std::sync::atomic::{AtomicBool, Ordering};
use std::sync::Arc;

pub const ENV_MQTT_BRIDGE_ENABLE: &str = "SDKWORK_AIOT_DEVICE_EDGE_MQTT_BRIDGE_ENABLE";
